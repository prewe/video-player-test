...
function () {
  ...
  _createClass(Model, [{
    key: "addVideoList",
    value: function addVideoList() {
      return fetch('./videolist.json').then(function (response) {
...
function () {
  function View(model) {
    ...
    this._model = model;
    this._wrapper = (0, _jquery.default)('.app');
    this._videolist = this._model._videolist;
  }

  _createClass(View, [{
    key: "createVideoContainer",
    value: function createVideoContainer(src) {
      var _this = this;

      return (0, _jquery.default)("<div class=\"video__container\">             \n                <video class=\"video\" src=\"".concat(src, "\"></video> \n              </div>")).on('click', function () {
        return _this.addFullVid(src);
      });
    }
  }, {
    key: "addVideo",
    ...
    key: "addCloseVid",
    value: function addCloseVid() {
      return (0, _jquery.default)("<div class=\"closevid\"></div>").on('click', function () {
        return (0, _jquery.default)('.fullvid').remove();
      });
    }
  }, {
    key: "addControls",
    ...
    value: function togglePlayPause() {
      var video = document.querySelector('.full-video');
